...
If you want to skip all of the "How to Host for "Fileless" Execution" steps and just execute Proxima with a already done powershell command, use this one (obfuscated):
```powershell
